...
public class Market {
    ...
    public void populateMarket() {
        products.add(new Product("Water", (int) (Math.random() * 100), 30 + (int) (Math.random() * 24)));
        products.add(new Product("Furs", (int) (Math.random() * 50), 250 + (int) (Math.random() * 70)));
        products.add(new Product("Food", (int) (Math.random() * 200), 105 + (int) (Math.random() * 30)));
        products.add(new Product("Ore", (int) (Math.random() * 50), 390 + (int) (Math.random() * 100)));
        products.add(new Product("Medicine", (int) (Math.random() * 5), 700 + (int) (Math.random() * 200)));
